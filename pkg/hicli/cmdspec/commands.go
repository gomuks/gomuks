...
var CommandDefinitions = []*event.MSC4391BotCommandEventContent{{
	Command:     Meow,
	Description: event.MakeExtensibleText("Meow"),
	Parameters: []*event.MSC4391Parameter{{
		Key:         "meow",
		Type:        event.BotArgumentTypeString.Schema(),
		Description: event.MakeExtensibleText("Meow"),
	}},
}, {
	Command:     Join,
	...
	Parameters: []*event.MSC4391Parameter{{
		Key:         "user_id",
		Type:        event.BotArgumentTypeUserID.Schema(),
	...
	Parameters: []*event.MSC4391Parameter{{
		Key:         "event_id",
		Type:        event.BotArgumentTypeEventID.Schema(),
